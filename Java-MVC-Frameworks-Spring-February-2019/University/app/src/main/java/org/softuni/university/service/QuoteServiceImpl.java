...
public class QuoteServiceImpl implements QuoteService {
    ...
    public QuoteServiceModel findQuoteById(String id) {
        Quote quote = this.quoteRepository.findById(id)
                .orElseThrow(() -> new QuoteNotFoundException(ServiceConstants.NOT_FOUND_EXCEPTION_WITH_THE_GIVEN_ID));
    ...
    @Scheduled(fixedRate = ServiceConstants.SELECT_QUOTE_SCHEDULED_FIXED_RATE)
