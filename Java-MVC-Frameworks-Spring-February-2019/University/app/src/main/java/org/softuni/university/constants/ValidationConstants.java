...
public final class ValidationConstants {
    ...
    public final static String USERNAME_LENGTH = "Username must be between 6 and 20 characters long!";

    public final static String PASSWORDS_LENGTH = "Username must be between 6 and 20 characters long!";
