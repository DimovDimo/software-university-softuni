...
public final class InterceptorConstants {
    ...
    public final static String ICON_LINK = "https://res.cloudinary.com/dimo-cloud/image/upload/v1554834927/icon2.png";

    public final static String ICON_LINK_MODEL_AND_VIEW = "iconLink";

    public final static String IMAGE_LINK_MODEL_AND_VIEW = "imageLink";

    public final static String TITLE_TEXT_MODEL_AND_VIEW = "titleText";

    public final static String MINUS_SIGN = " - ";

    //TODO
    public final static String[] GET_IMAGES = new String[]{
