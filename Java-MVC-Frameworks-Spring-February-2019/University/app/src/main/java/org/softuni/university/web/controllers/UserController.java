...
public class UserController extends BaseController {
    ...
    public ModelAndView register(
            ...
            @ModelAttribute(name = ControllerConstants.MODEL) UserRegisterBindingModel model
    ) {
        modelAndView.addObject(ControllerConstants.MODEL, model);
    ...
    public ModelAndView editProfile(
            Principal principal,
            ModelAndView modelAndView,
            @ModelAttribute(name = ControllerConstants.MODEL) UserEditBindingModel model
    ) {
        UserServiceModel userServiceModel = this.userService.findUserByUserName(principal.getName());
    ...
    @PatchMapping("/edit")
    @PreAuthorize("isAuthenticated()")
    public ModelAndView editProfileConfirm(ModelAndView modelAndView, @ModelAttribute(name = ControllerConstants.MODEL) UserEditBindingModel model, BindingResult bindingResult) {
    ...
    public ModelAndView allUsers(ModelAndView modelAndView) {
        ...
        modelAndView.addObject(ControllerConstants.USERS, users);
    ...
    public ModelAndView setStudent(@PathVariable String id) throws Exception {
        this.userService.setUserRole(id, RoleConstants.SET_USER_ROLE_CASE_STUDENT);
    ...
    public ModelAndView setPublicRelations(@PathVariable String id) throws Exception {
        this.userService.setUserRole(id, RoleConstants.SET_USER_ROLE_CASE_PUBLIC);
    ...
    public ModelAndView setChair(@PathVariable String id) throws Exception {
        this.userService.setUserRole(id, RoleConstants.SET_USER_ROLE_CASE_CHAIR);
    ...
    public ModelAndView setDean(@PathVariable String id) throws Exception {
        this.userService.setUserRole(id, RoleConstants.SET_USER_ROLE_CASE_DEAN);
    ...
    private boolean bindingResultHasErrors(ModelAndView modelAndView, @ModelAttribute(name = ControllerConstants.MODEL) UserRegisterBindingModel model, BindingResult bindingResult) {
    ...
    private boolean editValidator(ModelAndView modelAndView, @ModelAttribute(name = ControllerConstants.MODEL) UserEditBindingModel model, BindingResult bindingResult) {
