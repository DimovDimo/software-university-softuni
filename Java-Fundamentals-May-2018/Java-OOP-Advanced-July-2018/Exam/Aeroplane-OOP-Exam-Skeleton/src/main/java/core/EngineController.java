...
public class EngineController implements Engine {
    ...
    public EngineController(ConsoleReader reader, ConsoleWriter writer, AirportManager airportController,
                            FlightManager flightController) {
        this.reader = reader;
        this.writer = writer;
    ...
    public String processCommand(String input) throws OperationNotSupportedException {
        ...
        switch (command) {
            ...
            case "RegisterBag": {
                ...
                List<String> bagItems = Arrays.stream(args).skip(1).collect(Collectors.toList());
            ...
            case "CheckIn": {
                ...
                List<Integer> bagCheckInIndices = Arrays.stream(args)
                        .skip(2)
